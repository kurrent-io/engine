...
A repo-wide rename is in progress: README, ROADMAP, and the agent skill use the decided
names while this code still uses the current ones — the mapping table is in the root
CLAUDE.md.  When working in this code, use the current names.
